...
# EXIBIÇÃO DOS PONTOS E DE VIDA NA TELA DO JOGO
...
# MUNIÇÃO DO JOGADOR E DO INIMIGO
...
while run:
    ...
    for j in danos2:
        ...
        if player.vida <= 0:
            print('GAME OVER')
            # Exibe a mensagem de GAME OVER e o score final
            font = pygame.font.SysFont('Small Fonts', 74)
